...
router.post('/flows/:id/export', authorize('admin', 'manager'), automationController.exportFlow);
router.post('/flows/import', authorize('admin', 'manager'), automationController.importFlow);
